...
export interface ApprovalPolicyResource {
    ...
    script: ApprovalPolicyResource.Script.Item[];
    ...
    status: ApprovalPolicyResource.Status;
    ...
    trigger?: ApprovalPolicyResource.Trigger;
    updated_by?: string;
}

export namespace ApprovalPolicyResource {
