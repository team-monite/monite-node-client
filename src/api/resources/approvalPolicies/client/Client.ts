...
import { Processes } from "../resources/processes/client/Client.js";
...
export class ApprovalPolicies {
    protected readonly _options: ApprovalPolicies.Options;
    protected _processes: Processes | undefined;

    constructor(_options: ApprovalPolicies.Options) {
