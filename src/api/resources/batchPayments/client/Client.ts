...
export class BatchPayments {
    ...
    public async create(
    ...
    ): Promise<Monite.PaymentsBatchPaymentResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError("Timeout exceeded when calling POST /batch_payments.");
            case "unknown":
                throw new errors.MoniteError({
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError(
                    "Timeout exceeded when calling GET /batch_payments/{batch_payment_id}."
                );
            case "unknown":
                throw new errors.MoniteError({
                    message: _response.error.errorMessage,
