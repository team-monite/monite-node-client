...
export declare namespace OnboardingLinks {
    interface Options {
...
export class OnboardingLinks {
    constructor(protected readonly _options: OnboardingLinks.Options) {}

    /**
     * @param {Monite.OnboardingLinkRequest} request
     * @param {OnboardingLinks.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async create(
    ...
    ): Promise<Monite.OnboardingLinkPublicResponse> {
        ...
        if (_response.ok) {
            return _response.body as Monite.OnboardingLinkPublicResponse;
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError("Timeout exceeded when calling POST /onboarding_links.");
            case "unknown":
                throw new errors.MoniteError({
