...
describe("Payables", () => {
    ...
    test("create", async () => {
        ...
        const rawResponseBody = {
            ...
            other_extracted_data: {
                ...
                counterpart_branch_number: "counterpart_branch_number",
    ...
    test("get_payables_id_suggestions", async () => {
        const server = mockServerPool.createServer();
        const client = new MoniteClient({
            token: "test",
            moniteVersion: "test",
        ...
        const response = await client.payables.getPayablesIdSuggestions("payable_id");
        expect(response).toEqual({
            suggested_counterpart: {
                id: "id",
                address_id: "address_id",
    ...
    test("delete_payables_id_suggestions", async () => {
        const server = mockServerPool.createServer();
        const client = new MoniteClient({
            token: "test",
            moniteVersion: "test",
        ...
        server
            .mockEndpoint()
            .delete("/payables/payable_id/suggestions")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.payables.deletePayablesIdSuggestions("payable_id");
        expect(response).toEqual({
            key: "value",
        });
    });
