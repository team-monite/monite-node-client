...
import { ApprovalPolicies } from "./api/resources/approvalPolicies/client/Client.js";
import { ApprovalRequests } from "./api/resources/approvalRequests/client/Client.js";
...
import { Counterparts } from "./api/resources/counterparts/client/Client.js";
import { CounterpartEInvoicingCredentials } from "./api/resources/counterpartEInvoicingCredentials/client/Client.js";
import { CustomVatRates } from "./api/resources/customVatRates/client/Client.js";
import { DataExports } from "./api/resources/dataExports/client/Client.js";
import { DeliveryNotes } from "./api/resources/deliveryNotes/client/Client.js";
import { PdfTemplates } from "./api/resources/pdfTemplates/client/Client.js";
import { EInvoicingSearch } from "./api/resources/eInvoicingSearch/client/Client.js";
import { EInvoicingConnections } from "./api/resources/eInvoicingConnections/client/Client.js";
import { Entities } from "./api/resources/entities/client/Client.js";
import { EntityUsers } from "./api/resources/entityUsers/client/Client.js";
import { Events } from "./api/resources/events/client/Client.js";
import { Files } from "./api/resources/files/client/Client.js";
import { Financing } from "./api/resources/financing/client/Client.js";
import { MailTemplates } from "./api/resources/mailTemplates/client/Client.js";
import { MailboxDomains } from "./api/resources/mailboxDomains/client/Client.js";
import { Mailboxes } from "./api/resources/mailboxes/client/Client.js";
import { MeasureUnits } from "./api/resources/measureUnits/client/Client.js";
import { Ocr } from "./api/resources/ocr/client/Client.js";
import { OverdueReminders } from "./api/resources/overdueReminders/client/Client.js";
import { CreditNotes } from "./api/resources/creditNotes/client/Client.js";
import { PurchaseOrders } from "./api/resources/purchaseOrders/client/Client.js";
import { Payables } from "./api/resources/payables/client/Client.js";
import { PaymentIntents } from "./api/resources/paymentIntents/client/Client.js";
import { PaymentLinks } from "./api/resources/paymentLinks/client/Client.js";
import { PaymentRecords } from "./api/resources/paymentRecords/client/Client.js";
import { PaymentReminders } from "./api/resources/paymentReminders/client/Client.js";
import { PaymentTerms } from "./api/resources/paymentTerms/client/Client.js";
import { Products } from "./api/resources/products/client/Client.js";
import { Projects } from "./api/resources/projects/client/Client.js";
import { Receipts } from "./api/resources/receipts/client/Client.js";
import { Receivables } from "./api/resources/receivables/client/Client.js";
import { Recurrences } from "./api/resources/recurrences/client/Client.js";
import { Roles } from "./api/resources/roles/client/Client.js";
import { PartnerSettings } from "./api/resources/partnerSettings/client/Client.js";
import { Tags } from "./api/resources/tags/client/Client.js";
import { TextTemplates } from "./api/resources/textTemplates/client/Client.js";
import { VatRates } from "./api/resources/vatRates/client/Client.js";
import { WebhookDeliveries } from "./api/resources/webhookDeliveries/client/Client.js";
import { WebhookSubscriptions } from "./api/resources/webhookSubscriptions/client/Client.js";
import { Accounting } from "./api/resources/accounting/client/Client.js";
...
export class MoniteClient {
    protected readonly _options: MoniteClient.Options;
    ...
    protected _customVatRates: CustomVatRates | undefined;
    ...
    protected _eInvoicingSearch: EInvoicingSearch | undefined;
    ...
    protected _receipts: Receipts | undefined;
    ...
    constructor(_options: MoniteClient.Options) {
        this._options = {
            ...
            headers: mergeHeaders(
                {
                    "x-monite-version": _options?.moniteVersion,
                    "x-monite-entity-id": _options?.moniteEntityId,
    ...
    public get customVatRates(): CustomVatRates {
        return (this._customVatRates ??= new CustomVatRates(this._options));
    }
    ...
    public get eInvoicingSearch(): EInvoicingSearch {
        return (this._eInvoicingSearch ??= new EInvoicingSearch(this._options));
    }
