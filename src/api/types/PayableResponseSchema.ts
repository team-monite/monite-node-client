...
export interface PayableResponseSchema {
    ...
    other_extracted_data?: PayableResponseSchema.OtherExtractedData;
...
export namespace PayableResponseSchema {
    /**
     * Data extracted from the uploaded payable by OCR.
     */
    export type OtherExtractedData = Monite.OcrResponseInvoiceReceiptData | Monite.OcrRecognitionResponse;
}
