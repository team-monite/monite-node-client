...
export class Payables {
    protected readonly _options: Payables.Options;
    protected _lineItems: LineItems | undefined;

    constructor(_options: Payables.Options) {
    ...
    private async __get(
        ...
        if (hasTags != null) {
            _queryParams["has_tags"] = hasTags.toString();
        }
     ...
     *
     * @param {Monite.PayableUploadFile} request
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
    ...
    public uploadFromFile(
        ...
        return core.HttpResponsePromise.fromPromise(this.__uploadFromFile(request, requestOptions));
    }
     ...
     *
     * @param {string} payableId
     * @param {Monite.PayableAttachFile} request
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
    ...
    public attachFileById(
        ...
        return core.HttpResponsePromise.fromPromise(this.__attachFileById(payableId, request, requestOptions));
    }
     ...
     *
     * @param {string} payableId - The unique identifier of the payable whose history you want to retrieve.
     * @param {Monite.GetPayablesIdHistoryRequest} request
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
     ...
     */
    public getPayablesIdHistory(
        payableId: string,
        request: Monite.GetPayablesIdHistoryRequest = {},
        requestOptions?: Payables.RequestOptions,
    ): core.HttpResponsePromise<Monite.PayableHistoryPaginationResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getPayablesIdHistory(payableId, request, requestOptions));
    }

    private async __getPayablesIdHistory(
        payableId: string,
        request: Monite.GetPayablesIdHistoryRequest = {},
        requestOptions?: Payables.RequestOptions,
    ): Promise<core.WithRawResponse<Monite.PayableHistoryPaginationResponse>> {
        const {
            order,
            limit,
            pagination_token: paginationToken,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MoniteEnvironment.Sandbox,
                `payables/${encodeURIComponent(payableId)}/history`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
        ...
        if (_response.ok) {
            return {
                data: _response.body as Monite.PayableHistoryPaginationResponse,
                rawResponse: _response.rawResponse,
            };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError(
                    "Timeout exceeded when calling GET /payables/{payable_id}/history.",
                );
            case "unknown":
                throw new errors.MoniteError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {string} payableId - The unique identifier of the payable you want to reopen.
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
     ...
     *
     * @param {string} payableId - The unique identifier of the payable you want to find matching suggestions for.
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
     ...
     */
    public getPayablesIdSuggestions(
        payableId: string,
        requestOptions?: Payables.RequestOptions,
    ): core.HttpResponsePromise<Monite.SuggestedResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getPayablesIdSuggestions(payableId, requestOptions));
    }

    private async __getPayablesIdSuggestions(
        payableId: string,
        requestOptions?: Payables.RequestOptions,
    ): Promise<core.WithRawResponse<Monite.SuggestedResponse>> {
        var _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({
                Authorization: await this._getAuthorizationHeader(),
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.MoniteEnvironment.Sandbox,
                `payables/${encodeURIComponent(payableId)}/suggestions`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        if (_response.ok) {
            return { data: _response.body as Monite.SuggestedResponse, rawResponse: _response.rawResponse };
        }
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError(
                    "Timeout exceeded when calling GET /payables/{payable_id}/suggestions.",
                );
            case "unknown":
                throw new errors.MoniteError({
                    message: _response.error.errorMessage,
     ...
     *
     * @param {string} payableId - The unique identifier of the payable whose suggestions you want to delete.
     * @param {Payables.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Monite.BadRequestError}
     * @throws {@link Monite.UnauthorizedError}
     ...
     */
    public deletePayablesIdSuggestions(
        payableId: string,
        requestOptions?: Payables.RequestOptions,
    ): core.HttpResponsePromise<unknown> {
        return core.HttpResponsePromise.fromPromise(this.__deletePayablesIdSuggestions(payableId, requestOptions));
    }

    private async __deletePayablesIdSuggestions(
        payableId: string,
        requestOptions?: Payables.RequestOptions,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError(
                    "Timeout exceeded when calling DELETE /payables/{payable_id}/suggestions.",
                );
            case "unknown":
                throw new errors.MoniteError({
                    message: _response.error.errorMessage,
