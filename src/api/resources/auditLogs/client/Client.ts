...
export class AuditLogs {
    ...
    public async get(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError("Timeout exceeded when calling GET /audit_logs.");
            case "unknown":
                throw new errors.MoniteError({
    ...
    public async getById(logId: string, requestOptions?: AuditLogs.RequestOptions): Promise<Monite.LogResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.MoniteTimeoutError("Timeout exceeded when calling GET /audit_logs/{log_id}.");
            case "unknown":
                throw new errors.MoniteError({
                    message: _response.error.errorMessage,
                });
