...
export class Analytics {
     ...
     *     })
     */
    public getAnalyticsCreditNotes(
        request: Monite.GetAnalyticsCreditNotesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): core.HttpResponsePromise<Monite.PayableAnalyticsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAnalyticsCreditNotes(request, requestOptions));
    }

    private async __getAnalyticsCreditNotes(
        request: Monite.GetAnalyticsCreditNotesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): Promise<core.WithRawResponse<Monite.PayableAnalyticsResponse>> {
        const {
            dimension,
            metric,
        ...
        if (_response.ok) {
            return { data: _response.body as Monite.PayableAnalyticsResponse, rawResponse: _response.rawResponse };
        }
     ...
     *     })
     */
    public getAnalyticsPayables(
        request: Monite.GetAnalyticsPayablesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): core.HttpResponsePromise<Monite.PayableAnalyticsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAnalyticsPayables(request, requestOptions));
    }

    private async __getAnalyticsPayables(
        request: Monite.GetAnalyticsPayablesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): Promise<core.WithRawResponse<Monite.PayableAnalyticsResponse>> {
        const {
     ...
     *     })
     */
    public getAnalyticsReceivables(
        request: Monite.GetAnalyticsReceivablesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): core.HttpResponsePromise<Monite.ReceivablesAnalyticsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAnalyticsReceivables(request, requestOptions));
    }

    private async __getAnalyticsReceivables(
        request: Monite.GetAnalyticsReceivablesRequest,
        requestOptions?: Analytics.RequestOptions,
    ): Promise<core.WithRawResponse<Monite.ReceivablesAnalyticsResponse>> {
        const {
            dimension,
            metric,
            aggregation_function: aggregationFunction,
        ...
        if (_response.ok) {
            return { data: _response.body as Monite.ReceivablesAnalyticsResponse, rawResponse: _response.rawResponse };
        }
