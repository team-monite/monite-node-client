 ...
 *     {}
 */
export interface GetPayablesIdHistoryRequest {
    ...
    sort?: Monite.PayableHistoryCursorFields;
    /** Return only the specified event types */
    event_type__in?: Monite.PayableHistoryEventTypeEnum | Monite.PayableHistoryEventTypeEnum[];
    /**
